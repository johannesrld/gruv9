...
M.highlights.lsp_type_enum_member_rust = Highlight.new("@lsp.type.enumMember", { link = vim_hl.type })
M.highlights.lsp_type_member = Highlight.new("@lsp.type.member", { link = vim_hl.func })
...
M.highlights.lsp_type_macro = Highlight.new("@lsp.type.macro", { link = vim_hl.func })
-- M.highlights.lsp_type_method = Highlight.new("@lsp.type.method", {})
M.highlights.lsp_type_namespace = Highlight.new("@lsp.type.namespace", { link = gruber_hl.quartz })
-- M.highlights.lsp_type_parameter = Highlight.new("@lsp.type.parameter", {})
M.highlights.lsp_type_parameter_python = Highlight.new("@lsp.type.parameter.python", { link = "@none"})
...
M.highlights.lsp_type_type_builtin_type = Highlight.new("@lsp.type.builtinType", { link = vim_hl.type })
M.highlights.lsp_type_keyword = Highlight.new("@lsp.type.keyword", { link = gruber_hl.yellow })
M.highlights.lsp_typemod_variable_callable = Highlight.new("@lsp.typemod.variable.callable", { link = vim_hl.func })
M.highlights.lsp_typemod_variable_static = Highlight.new("@lsp.typemod.variable.static", { link = vim_hl.constant })
